...
def computeConstrainedDelaunayTriangulation(points, segmentsConstraints):
    """
    This will return a constrained Delaunay triangulation.

    Input
    points: array of QgsPoint
    segmentsConstraints: array of 2uples being the index of the linked points
    ...
    QgsMessageLog.logMessage("All the triangles : %s" % str(triangles))
    ...
    for segment in segmentsConstraints:
